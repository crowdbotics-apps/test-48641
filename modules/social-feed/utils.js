...
export const toggleFollowById = (followers, targetId) => {
  ...
  const index = followers.findIndex(obj => obj.id === targetId); // If the object with the targetId is found, toggle its "follow" value

  if (index !== -1) {
    // Create a shallow copy of the array
    const updatedObjects = [...followers]; // Toggle the "follow" value

    updatedObjects[index] = { ...updatedObjects[index],
